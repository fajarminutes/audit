...
const EditDataGdm = () => {                
    ...
    const fetchGdmData = async () => {      
        try {      
            ...
            setFormData({      
                entity: data.entity.split(', '), // Ubah menjadi array      
                potongan_gdm_finance: data.potongan_gdm_finance,      
                nama_customer: data.nama_customer,      
                total_gdm_ditagihkan: data.total_gdm_ditagihkan,      
                status: data.status,      
                keterangan: data.keterangan,      
                nomor_pengajuan: data.nomor_pengajuan, // Tambahkan nomor_pengajuan    
            });  
      
            // Set selected option for nomor_pengajuan  
            const selectedOption = pengajuanData.find(p => p.nomor_pengajuan === data.nomor_pengajuan);  
            if (selectedOption) {  
                handlePengajuanChange({ value: selectedOption.nomor_pengajuan, label: selectedOption.nomor_pengajuan });  
            }  
        } catch (error) {      
    ...
    const handleSubmit = async (e) => {      
        ...
        try {      
            ...
            if (response.ok) {      
                showToast('success', 'Data GDM berhasil diperbarui!');      
                                    ...
                                    <form onSubmit={handleSubmit}>              
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">      
                                            ...
                                            <div>              
                                                ...
                                                <input id="selisih" type="number" placeholder="Masukkan Selisih" className="form-input form-input-lg" value={parseFloat(formData.total_gdm_ditagihkan) - parseFloat(formData.potongan_gdm_finance)} readOnly />    
                                            </div>            
                                            <div>              
