...
const TambahPengajuan = () => {
    ...
    // Inisialisasi formData sebagai objek biasa  
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const responsePengajuans = await fetch('https://audtrax.sinarjernihsuksesindo.id/backend/api/pengajuans');
                const pengajuans = await responsePengajuans.json();
    
                // Filter kode_entity yang belum ada di pengajuans
    ...
    const handleSubmit = async (e: React.FormEvent) => {  
        ...
        try {  
            const response = await axios.post('https://audtrax.sinarjernihsuksesindo.id/backend/api/pengajuans', payload);  
